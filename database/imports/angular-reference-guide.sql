...
-- Paste into Local Sandbox Editor > Batch SQL.
...
SELECT 'rec-angular-reference-guide', id
FROM tags
...
SELECT
  ...
  'frontend-framework',
  'angular',
  'TypeScript web application framework with routing, DI, forms, HTTP, testing, and CLI tooling.',
  'https://angular.dev/',
  NULL
...
('angular-glance','rec-angular-reference-guide','grid',NULL,'Angular at a Glance',NULL,'<p><strong>Angular</strong> is a TypeScript web application framework with components, templates, dependency injection, routing, forms, HTTP, reactive state, testing, and a first-party CLI.</p><p>This guide targets Angular 22.1-era standalone applications.</p>',NULL,NULL,20,0,0,'','{"mode":"default","category":"Angular"}'),
('angular-install','rec-angular-reference-guide','split',NULL,'macOS Setup & Installation',NULL,'<p>Use a Node version manager on a development Mac so projects can target supported Node versions cleanly.</p>',NULL,'<p>Columns: <strong>Purpose / Commands / Notes</strong>.</p>',30,0,0,'','{"mode":"three-column-default","category":"Angular"}'),
('angular-project','rec-angular-reference-guide','split',NULL,'Create & Run a Project',NULL,'<p><code>ng new</code> creates an Angular workspace and starter application.</p>',NULL,NULL,40,0,0,'','{"mode":"half-default","category":"Angular"}'),
...
('angular-workspace','rec-angular-reference-guide','grid',NULL,'Workspace & File Map',NULL,'<p>Common files in a current standalone Angular application.</p>',NULL,NULL,60,0,0,'','{"mode":"default","category":"Angular"}'),
('angular-components','rec-angular-reference-guide','code',NULL,'Components & Directives',NULL,'<p>Components define UI with a template. Directives package reusable behavior on existing hosts.</p>',NULL,NULL,70,0,0,'','{"mode":"collapse-list","category":"Angular"}'),
...
('angular-signals','rec-angular-reference-guide','code',NULL,'Signals & Reactive State',NULL,'<p>Signals are synchronous reactive primitives. Read a signal by calling it as a function.</p>',NULL,NULL,90,0,0,'','{"mode":"collapse-list","category":"Angular"}'),
('angular-io','rec-angular-reference-guide','code',NULL,'Inputs & Outputs',NULL,'<p>Inputs pass data into components. Outputs emit custom events to consumers.</p>',NULL,NULL,100,0,0,'','{"mode":"collapse-list","category":"Angular"}'),
...
('angular-routing','rec-angular-reference-guide','code',NULL,'Router Quick Reference',NULL,'<p>Routes map URLs to components. Angular uses first-match wins.</p>',NULL,NULL,120,0,0,'','{"mode":"collapse-list","category":"Angular"}'),
('angular-forms','rec-angular-reference-guide','code',NULL,'Forms',NULL,'<p>Reactive forms remain a strong stable default. Template-driven and Signal Forms are also available.</p>',NULL,NULL,130,0,0,'','{"mode":"collapse-list","category":"Angular"}'),
...
('angular-rxjs','rec-angular-reference-guide','code',NULL,'RxJS Essentials',NULL,'<p>Signals fit synchronous state; RxJS remains useful for asynchronous streams and HTTP pipelines.</p>',NULL,NULL,150,0,0,'','{"mode":"collapse-list","category":"Angular"}'),
('angular-lifecycle','rec-angular-reference-guide','code',NULL,'Lifecycle & Cleanup',NULL,'<p>Use lifecycle hooks when timing matters and <code>DestroyRef</code> for explicit cleanup close to setup code.</p>',NULL,NULL,160,0,0,'','{"mode":"collapse-list","category":"Angular"}'),
('angular-testing','rec-angular-reference-guide','code',NULL,'Testing',NULL,'<p>New CLI projects use Vitest by default. TestBed remains the Angular-aware testing utility.</p>',NULL,NULL,170,0,0,'','{"mode":"collapse-list","category":"Angular"}'),
('angular-build','rec-angular-reference-guide','code',NULL,'Build, Update & Deploy',NULL,'<p>Build optimized output for deployment; do not deploy the development server.</p>',NULL,NULL,180,0,0,'','{"mode":"collapse-list","category":"Angular"}'),
('angular-practices','rec-angular-reference-guide','standard',NULL,'Modern Implementation Practices',NULL,'<p>Current defaults for new Angular work plus compatibility guidance for existing projects.</p>',NULL,NULL,190,0,0,'','{"mode":"collapse-list","category":"Angular"}'),
('angular-troubleshoot','rec-angular-reference-guide','grid',NULL,'Troubleshooting Fast Map',NULL,'<p>Check runtime versions, imports, route order, and workspace context before reinstalling everything.</p>',NULL,NULL,200,0,0,'','{"mode":"default","category":"Angular"}'),
('angular-docs','rec-angular-reference-guide','standard',NULL,'Official Documentation & Downloads',NULL,'<p>Use current official documentation whenever setup or API behavior is version-sensitive.</p>',NULL,NULL,210,0,0,'','{"mode":"link-list","category":"Angular"}');
...
('angular-nav-5','rec-angular-reference-guide','standard','angular-nav','Components','Components',50,'{"url":"#node-angular-components"}'),
('angular-nav-6','rec-angular-reference-guide','standard','angular-nav','Templates','Templates',60,'{"url":"#node-angular-templates"}'),
('angular-nav-7','rec-angular-reference-guide','standard','angular-nav','Signals','Signals',70,'{"url":"#node-angular-signals"}'),
('angular-nav-8','rec-angular-reference-guide','standard','angular-nav','Routing','Routing',80,'{"url":"#node-angular-routing"}'),
('angular-nav-9','rec-angular-reference-guide','standard','angular-nav','Forms','Forms',90,'{"url":"#node-angular-forms"}'),
('angular-nav-10','rec-angular-reference-guide','standard','angular-nav','HTTP','HTTP',100,'{"url":"#node-angular-http"}'),
('angular-nav-11','rec-angular-reference-guide','standard','angular-nav','Testing','Testing',110,'{"url":"#node-angular-testing"}'),
('angular-nav-12','rec-angular-reference-guide','standard','angular-nav','Docs','Docs',120,'{"url":"#node-angular-docs"}');

-- AT A GLANCE
INSERT INTO content_nodes (id, record_id, type, parent_id, title, content, sort_order, metadata)
VALUES
('angular-glance-version','rec-angular-reference-guide','standard','angular-glance','Current Major','<p>Angular 22 is active. Current angular.dev pages are built with Angular <strong>22.1.4</strong>.</p>',10,'{}'),
...
('angular-glance-standalone','rec-angular-reference-guide','standard','angular-glance','Standalone-first','<p>New components are standalone by default and import template dependencies directly.</p>',40,'{}'),
('angular-glance-signals','rec-angular-reference-guide','standard','angular-glance','Signals','<p><code>signal()</code> stores state; <code>computed()</code> derives values.</p>',50,'{}'),
('angular-glance-flow','rec-angular-reference-guide','standard','angular-glance','Control Flow','<p>Use <code>@if</code>, <code>@for</code>, and <code>@switch</code> in modern templates.</p>',60,'{}'),
...
('angular-glance-test','rec-angular-reference-guide','standard','angular-glance','Testing','<p>New CLI projects use Vitest. Run with <code>ng test</code>.</p>',80,'{}');

-- macOS SETUP — THREE COLUMN SPLIT
INSERT INTO content_nodes (id, record_id, type, parent_id, title, description, content, sort_order, metadata)
VALUES
('angular-install-node','rec-angular-reference-guide','standard','angular-install','Node + npm','<p><strong>Purpose:</strong> Angular CLI runs on Node and npm.</p>','<pre><code>nvm install 24\nnvm use 24\nnode -v\nnpm -v</code></pre>',10,'{"additionalHtml":"<p><strong>Notes:</strong> Node 24.15+ satisfies Angular 22. Use a project .nvmrc when a team standardizes on one Node major.</p>"}'),
('angular-install-cli','rec-angular-reference-guide','standard','angular-install','Angular CLI','<p><strong>Purpose:</strong> install the <code>ng</code> command.</p>','<pre><code>npm install -g @angular/cli\nng version\nwhich ng</code></pre>',20,'{"additionalHtml":"<p><strong>Notes:</strong> with nvm, routine sudo npm installs should not be necessary.</p>"}'),
('angular-install-tools','rec-angular-reference-guide','standard','angular-install','Editor Tooling','<p><strong>Purpose:</strong> completion, diagnostics, navigation, and refactoring.</p>','<ul><li>VS Code or WebStorm</li><li>Angular Language Service</li><li>Browser DevTools</li></ul>',30,'{"additionalHtml":"<p>Use <code>ng completion</code> for CLI shell completion.</p>"}');

-- CREATE PROJECT — HALF SPLIT
INSERT INTO content_nodes (id, record_id, type, parent_id, title, description, content, sort_order, metadata)
VALUES
('angular-project-new','rec-angular-reference-guide','standard','angular-project','Create Workspace','<p>Create the workspace and initial application.</p>','<pre><code>ng new my-app\ncd my-app</code></pre>',10,'{}'),
('angular-project-options','rec-angular-reference-guide','standard','angular-project','Routing + SCSS','<p>Set common options explicitly.</p>','<pre><code>ng new my-app --routing --style=scss</code></pre>',20,'{}'),
...
('angular-project-url','rec-angular-reference-guide','standard','angular-project','Default URL','<p>Default CLI development address.</p>','<pre><code>http://localhost:4200/</code></pre>',40,'{}'),
('angular-project-port','rec-angular-reference-guide','standard','angular-project','Different Port','<p>Use another port when 4200 is occupied.</p>','<pre><code>ng serve --port 4300</code></pre>',50,'{}');
...
('angular-cli-help','rec-angular-reference-guide','standard','angular-cli','Help','<p>Inspect commands and options.</p>',20,'{"code":"ng help\nng generate component --help"}'),
('angular-cli-new','rec-angular-reference-guide','standard','angular-cli','New Workspace','<p>Create a workspace and starter app.</p>',30,'{"code":"ng new my-app"}'),
('angular-cli-serve','rec-angular-reference-guide','standard','angular-cli','Serve','<p>Development server and watcher.</p>',40,'{"code":"ng serve\nng serve -o\nng serve --port 4300"}'),
('angular-cli-build','rec-angular-reference-guide','standard','angular-cli','Build','<p>Create build output.</p>',50,'{"code":"ng build\nng build --configuration production"}'),
...
('angular-cli-guard','rec-angular-reference-guide','standard','angular-cli','Generate Guard','<p>Scaffold a route guard.</p>',100,'{"code":"ng g guard auth/auth"}'),
...
('angular-cli-add','rec-angular-reference-guide','standard','angular-cli','ng add','<p>Install and configure a package with Angular schematics.</p>',130,'{"code":"ng add @angular/material"}'),
('angular-cli-update','rec-angular-reference-guide','standard','angular-cli','Update','<p>Show updates or run migrations.</p>',140,'{"code":"ng update\nng update @angular/core @angular/cli"}'),
...
('angular-cli-completion','rec-angular-reference-guide','standard','angular-cli','Completion','<p>Set up shell completion.</p>',160,'{"code":"ng completion"}');
...
('angular-file-tsconfig','rec-angular-reference-guide','standard','angular-workspace','tsconfig.json','<p>TypeScript compiler configuration.</p>',30,'{}'),
...
('angular-file-config','rec-angular-reference-guide','standard','angular-workspace','app.config.ts','<p>Application-level providers such as router and HTTP configuration.</p>',50,'{}'),
...
('angular-file-dist','rec-angular-reference-guide','standard','angular-workspace','dist/','<p>Generated build output. Do not hand-edit it.</p>',80,'{}');

-- COMPONENTS & DIRECTIVES
INSERT INTO content_nodes (id, record_id, type, parent_id, title, description, sort_order, metadata)
VALUES
('angular-component-min','rec-angular-reference-guide','standard','angular-components','Minimal Component','<p>Component metadata defines selector and template.</p>',10,'{"code":"import { Component } from \"@angular/core\";\n\n@Component({\n  selector: \"app-greeting\",\n  template: `<h2>Hello Angular</h2>`,\n})\nexport class Greeting {}"}'),
...
('angular-component-imports','rec-angular-reference-guide','standard','angular-components','Standalone Imports','<p>Import what the template uses.</p>',30,'{"code":"import { RouterLink } from \"@angular/router\";\n\n@Component({\n  selector: \"app-nav\",\n  imports: [RouterLink],\n  template: `<a routerLink=\"/about\">About</a>`,\n})\nexport class Nav {}"}'),
...
('angular-component-directive','rec-angular-reference-guide','standard','angular-components','Attribute Directive','<p>Package reusable behavior on an existing host element.</p>',50,'{"code":"@Directive({\n  selector: \"[appHighlight]\",\n  host: {\n    \"(mouseenter)\": \"active.set(true)\",\n    \"(mouseleave)\": \"active.set(false)\",\n    \"[class.highlight]\": \"active()\",\n  },\n})\nexport class Highlight {\n  active = signal(false);\n}"}');
...
('angular-template-for','rec-angular-reference-guide','standard','angular-templates','@for','<p>Repeat values and track stable identity.</p>',60,'{"code":"@for (item of items(); track item.id) {\n  <li>{{ item.name }}</li>\n} @empty {\n  <li>No items</li>\n}"}'),
('angular-template-switch','rec-angular-reference-guide','standard','angular-templates','@switch','<p>Choose among cases; no fallthrough.</p>',70,'{"code":"@switch (role()) {\n  @case (\"admin\") { <app-admin /> }\n  @case (\"editor\") { <app-editor /> }\n  @default { <app-viewer /> }\n}"}'),
('angular-template-pipe','rec-angular-reference-guide','standard','angular-templates','Pipes','<p>Transform values for display. Import standalone pipes used by the template.</p>',80,'{"code":"{{ total | currency }}\n{{ createdAt | date:\"medium\" }}"}');
...
('angular-signal-effect','rec-angular-reference-guide','standard','angular-signals','effect()','<p>Use effects for appropriate imperative side effects. Prefer <code>computed()</code> for derived state.</p>',50,'{"code":"logCount = effect(() => {\n  console.log(this.count());\n});"}');
...
('angular-io-old','rec-angular-reference-guide','standard','angular-io','Older Compatibility APIs','<p><code>@Input()</code>, <code>@Output()</code>, and <code>EventEmitter</code> remain supported in existing projects.</p>',50,'{"code":"@Input() user!: User;\n@Output() saved = new EventEmitter<User>();"}');
...
('angular-di-inject','rec-angular-reference-guide','standard','angular-di','inject()','<p>Current Angular style guidance prefers <code>inject()</code> for new code.</p>',20,'{"code":"private users = inject(UserService);\nprivate router = inject(Router);"}'),
('angular-di-component','rec-angular-reference-guide','standard','angular-di','Component Provider','<p>Create a service instance scoped to the component subtree.</p>',30,'{"code":"@Component({\n  providers: [DraftService],\n  template: `...`,\n})\nexport class Editor {}"}'),
...
('angular-route-link','rec-angular-reference-guide','standard','angular-routing','RouterLink','<p>Use Angular client-side navigation for internal links.</p>',40,'{"code":"@Component({\n  imports: [RouterLink],\n  template: `<a routerLink=\"/users\">Users</a>`,\n})\nexport class Nav {}"}'),
...
('angular-route-guard','rec-angular-reference-guide','standard','angular-routing','Guard','<p>Client guards control navigation but must not be the only authorization layer.</p>',70,'{"code":"export const authGuard: CanActivateFn = () => {\n  const auth = inject(AuthService);\n  return auth.isLoggedIn() ? true : inject(Router).createUrlTree([\"/login\"]);\n};"}');

-- FORMS
INSERT INTO content_nodes (id, record_id, type, parent_id, title, description, sort_order, metadata)
VALUES
('angular-form-control','rec-angular-reference-guide','standard','angular-forms','Reactive FormControl','<p>Model-driven explicit form state.</p>',10,'{"code":"imports: [ReactiveFormsModule]\n\nname = new FormControl(\"\", { nonNullable: true });\n\n<input [formControl]=\"name\">"}'),
('angular-form-group','rec-angular-reference-guide','standard','angular-forms','FormGroup','<p>Group related controls.</p>',20,'{"code":"profile = new FormGroup({\n  name: new FormControl(\"\", { nonNullable: true }),\n  email: new FormControl(\"\", { nonNullable: true }),\n});"}'),
('angular-form-validator','rec-angular-reference-guide','standard','angular-forms','Validators','<p>Attach validation rules to controls.</p>',30,'{"code":"email = new FormControl(\"\", {\n  nonNullable: true,\n  validators: [Validators.required, Validators.email],\n});"}'),
...
('angular-form-signal','rec-angular-reference-guide','standard','angular-forms','Signal Forms','<p>Angular 21+ signal-based field trees and validation. Evaluate current stability requirements before replacing established reactive forms.</p>',50,'{"code":"import { form, FormField } from \"@angular/forms/signals\";\n\nmodel = signal({ email: \"\" });\nloginForm = form(this.model);"}');

-- HTTP
INSERT INTO content_nodes (id, record_id, type, parent_id, title, description, sort_order, metadata)
VALUES
('angular-http-inject','rec-angular-reference-guide','standard','angular-http','Inject HttpClient','<p>Prefer a focused API or data service.</p>',10,'{"code":"private http = inject(HttpClient);"}'),
...
('angular-http-params','rec-angular-reference-guide','standard','angular-http','Query Parameters','<p>Pass query parameters through request options.</p>',30,'{"code":"return this.http.get<User[]>(\"/api/users\", {\n  params: { q: term }\n});"}'),
...
('angular-http-config','rec-angular-reference-guide','standard','angular-http','Configure HttpClient','<p>Use <code>provideHttpClient()</code> for interceptors or other features.</p>',60,'{"code":"providers: [\n  provideHttpClient(withInterceptors([authInterceptor]))\n]"}'),
...
('angular-rx-switch','rec-angular-reference-guide','standard','angular-rxjs','switchMap()','<p>Switch to a new inner stream and cancel the previous one.</p>',40,'{"code":"results$ = this.query$.pipe(\n  debounceTime(250),\n  distinctUntilChanged(),\n  switchMap(q => this.http.get<SearchResult[]>(\"/api/search\", { params: { q } }))\n);"}'),
('angular-rx-signal','rec-angular-reference-guide','standard','angular-rxjs','toSignal()','<p>Expose the latest Observable value as a signal.</p>',50,'{"code":"users = toSignal(this.users$, { initialValue: [] });"}');
...
('angular-life-render','rec-angular-reference-guide','standard','angular-lifecycle','afterNextRender','<p>Run DOM-dependent work after the next application render.</p>',30,'{"code":"afterNextRender(() => {\n  // DOM-dependent work\n});"}'),
...
('angular-test-bed','rec-angular-reference-guide','standard','angular-testing','TestBed Component','<p>Import a standalone component and create a fixture.</p>',30,'{"code":"await TestBed.configureTestingModule({\n  imports: [Profile],\n}).compileComponents();\n\nconst fixture = TestBed.createComponent(Profile);"}'),
('angular-test-dom','rec-angular-reference-guide','standard','angular-testing','Rendered DOM','<p>Wait for stability before asserting async rendering.</p>',40,'{"code":"const fixture = TestBed.createComponent(Profile);\nawait fixture.whenStable();\nconst el = fixture.nativeElement as HTMLElement;\nexpect(el.querySelector(\"h1\")?.textContent).toContain(\"Profile\");"}'),
('angular-test-http','rec-angular-reference-guide','standard','angular-testing','HTTP Testing','<p>Mock the HTTP backend instead of calling a real service.</p>',50,'{"code":"TestBed.configureTestingModule({\n  providers: [provideHttpClient(), provideHttpClientTesting()],\n});\n\nconst httpTesting = TestBed.inject(HttpTestingController);"}');
...
('angular-build-deploy','rec-angular-reference-guide','standard','angular-build','ng deploy','<p>Works after installing a deployment integration with a deploy builder.</p>',50,'{"code":"ng deploy"}');
...
('angular-practice-signals','rec-angular-reference-guide','standard','angular-practices','Signals for local state','<p>Use writable signals for local state and <code>computed()</code> for derived state.</p>',30,'{}'),
('angular-practice-for','rec-angular-reference-guide','standard','angular-practices','Track @for items','<p>Track stable identity such as <code>track item.id</code> to minimize DOM replacement.</p>',40,'{}'),
('angular-practice-components','rec-angular-reference-guide','standard','angular-practices','Keep components focused','<p>Move reusable data and business behavior to services or plain TypeScript functions.</p>',50,'{}'),
('angular-practice-lazy','rec-angular-reference-guide','standard','angular-practices','Lazy-load deliberately','<p>Lazy-load routes when it improves initial load cost; measure before over-splitting.</p>',60,'{}'),
('angular-practice-types','rec-angular-reference-guide','standard','angular-practices','Keep types strong','<p>Use interfaces and types for API payloads, inputs, forms, and route data.</p>',70,'{}'),
('angular-practice-security','rec-angular-reference-guide','standard','angular-practices','Respect security boundaries','<p>Keep Angular current, do not build templates from user input, and be cautious with APIs that bypass sanitization.</p>',80,'{}'),
('angular-practice-update','rec-angular-reference-guide','standard','angular-practices','Stay current','<p>Use <code>ng update</code>, release notes, and the Update Guide rather than skipping many major versions.</p>',90,'{}');

-- TROUBLESHOOTING GRID
INSERT INTO content_nodes (id, record_id, type, parent_id, title, content, sort_order, metadata)
VALUES
('angular-trouble-ng','rec-angular-reference-guide','standard','angular-troubleshoot','ng not found','<p>Check <code>which node</code>, <code>which npm</code>, and <code>npm prefix -g</code>. Install the CLI under the active nvm Node version.</p>',10,'{}'),
...
('angular-trouble-import','rec-angular-reference-guide','standard','angular-troubleshoot','Unknown Element / Pipe','<p>For standalone components, confirm the dependency appears in <code>imports</code>.</p>',40,'{}'),
('angular-trouble-binding','rec-angular-reference-guide','standard','angular-troubleshoot','Cannot Bind Property','<p>The component or directive input may not be imported, or the binding name may be wrong.</p>',50,'{}'),
('angular-trouble-di','rec-angular-reference-guide','standard','angular-troubleshoot','NullInjectorError','<p>A requested dependency has no provider in the active injector hierarchy.</p>',60,'{}'),
('angular-trouble-route','rec-angular-reference-guide','standard','angular-troubleshoot','Route Never Reached','<p>Router matching is first-match wins. Put specific routes first and <code>**</code> last.</p>',70,'{}'),
('angular-trouble-cors','rec-angular-reference-guide','standard','angular-troubleshoot','CORS Error','<p>CORS is a browser and server policy. Configure the backend or a development proxy.</p>',80,'{}'),
('angular-trouble-view','rec-angular-reference-guide','standard','angular-troubleshoot','View Not Updating','<p>In zoneless Angular, state changes need an Angular-recognized notification path such as signals, input changes, or template events.</p>',90,'{}'),
('angular-trouble-update','rec-angular-reference-guide','standard','angular-troubleshoot','After an Update','<p>Review migration output, reinstall from the lockfile, run <code>ng test</code>, then run <code>ng build</code>.</p>',100,'{}');

-- DOCUMENTATION LINK LIST
INSERT INTO content_nodes (id, record_id, type, parent_id, title, nav_label, content, sort_order, metadata)
VALUES
('angular-doc-home','rec-angular-reference-guide','standard','angular-docs','Angular Home','Open Angular Home','<p>Current documentation, tutorials, guides, and APIs.</p>',10,'{"url":"https://angular.dev/"}'),
...
('angular-doc-update','rec-angular-reference-guide','standard','angular-docs','Update Guide','Open Update Guide','<p>Interactive version migration guidance.</p>',70,'{"url":"https://angular.dev/update-guide"}'),
...
('angular-doc-routing','rec-angular-reference-guide','standard','angular-docs','Routing','Open Routing','<p>Routes, outlets, links, guards, and lazy loading.</p>',140,'{"url":"https://angular.dev/guide/routing"}'),
...
('angular-doc-testing','rec-angular-reference-guide','standard','angular-docs','Testing','Open Testing','<p>Current Vitest-based default testing.</p>',180,'{"url":"https://angular.dev/guide/testing"}'),
...
('angular-doc-style','rec-angular-reference-guide','standard','angular-docs','Style Guide','Open Style Guide','<p>Angular team naming, structure, and DI recommendations.</p>',200,'{"url":"https://angular.dev/style-guide"}'),
('angular-doc-security','rec-angular-reference-guide','standard','angular-docs','Security','Open Security','<p>Security model, sanitization, XSS protections, and security guidance.</p>',210,'{"url":"https://angular.dev/best-practices/security"}'),
('angular-doc-language','rec-angular-reference-guide','standard','angular-docs','Angular Language Service','Open Language Service','<p>Editor completion and template diagnostics.</p>',220,'{"url":"https://angular.dev/tools/language-service"}');
